...
export class UserComponent implements OnInit {
  ...
  apiproduct = environment.apiUrl + "product/KhachHang";;
  constructor(
  ...
  search(value) {
    ...
    if (value != "") {
      ...
      this.product_services.patchStateUser({ filter }, this.apiproduct + `?category_id=${this.catogy_id}`);
    }
    else {
  ...
  paginate(paginator: PaginatorState) {
    this.product_services.patchStateUser({ paginator }, this.apiproduct + `?category_id=${this.catogy_id}`);
  }
  sort(column: string) {
    ...
    this.product_services.patchStateUser({ sorting }, this.apiproduct + `?category_id=${this.catogy_id}`);
  }
